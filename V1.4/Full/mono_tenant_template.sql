...
-- START OF: 04_03_item_management_module.sql
-- ==========================================
...
-- Note: Foreign keys that reference tables in other modules (or are referenced by other modules)
-- remain in cross-module foreign key files
-- END OF: 04_03_item_management_module.sql

-- START OF: 05_cross_module_fk.sql
-- ==========================================
...
-- END OF: 05_cross_module_fk.sql

-- START OF: 06_item_polymorphic_validations.sql
...
-- END OF: 06_item_polymorphic_validations.sql

-- START OF: 07_04_location_management_module.sql
-- ==========================================
...
-- Note: Foreign keys that reference tables in other modules (or are referenced by other modules)
-- remain in cross-module foreign key files
-- END OF: 07_04_location_management_module.sql

-- START OF: 08_cross_module_fk.sql
-- ==========================================
...
-- END OF: 08_cross_module_fk.sql

-- START OF: 09_location_polymorphic_validations.sql
-- ==========================================
...
*/
-- END OF: 09_location_polymorphic_validations.sql

-- START OF: 10_05_booking_transactions_module.sql
-- ==========================================
...
-- END OF: 10_05_booking_transactions_module.sql

-- START OF: 11_cross_module_fk.sql
-- ==========================================
...
-- END OF: 11_cross_module_fk.sql

-- START OF: 12_booking_polymorphic_validations.sql
...
-- END OF: 12_booking_polymorphic_validations.sql

-- START OF: 13_06_reviews_ratings_module.sql
-- ==========================================
...
-- END OF: 13_06_reviews_ratings_module.sql

-- START OF: 14_cross_module_fk.sql
-- ==========================================
...
-- END OF: 14_cross_module_fk.sql

-- START OF: 15_07_messaging_module.sql
-- ==========================================
...
-- END OF: 15_07_messaging_module.sql

-- START OF: 16_cross_module_fk.sql
-- ==========================================
...
-- END OF: 16_cross_module_fk.sql

-- START OF: 17_08_admin_support_module.sql
-- ==========================================
...
-- END OF: 17_08_admin_support_module.sql

-- START OF: 18_cross_module_fk.sql
-- ==========================================
...
-- END OF: 18_cross_module_fk.sql

-- START OF: 19_09_analytics_reporting_module.sql
-- ==========================================
...
-- END OF: 19_09_analytics_reporting_module.sql

-- START OF: 20_cross_module_fk.sql
-- ==========================================
...
-- END OF: 20_cross_module_fk.sql

-- START OF: 21_10_security_compliance_module.sql
-- ==========================================
...
-- END OF: 21_10_security_compliance_module.sql

-- START OF: 22_cross_module_fk.sql
-- ==========================================
